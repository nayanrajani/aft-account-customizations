...
def lambda_handler(event, context):
    ...
    for log_group_name in log_groups_to_export:
        ...
        if export_to_time - int(ssm_value) < (12 * 60 * 60 * 1000):
            # Haven't been 12hrs from the last export of this log group
            # Log data can take up to 12 hours to become available for export.
            print("    Skipped until 12 hrs from last export is completed")
            continue
